...
<div class="container-fluid" id="dashboard_facebook_profile">
  <div class="row-fluid">
<div class="span12">
    	...
    	<div class="row-fluid">
    		...
    		<div class="span2 block-summary">
    			...
    			<div class="span6 right">
	    			...
	    			<span id="growth_comment_cl" class="growth red"><span id="growth_comment_num" class="fL">0%</span><i class="icon-caret-up"></i></span>
    			</div>
    		</div>
    	</div>
    </div>
