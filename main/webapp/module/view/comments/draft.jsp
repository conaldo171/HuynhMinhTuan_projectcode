<div class="container-fluid" id="contents_draft_comment">
	<div class="row-fluid">
    <div class="span8" id="show_content">
      <ul id="show_draft_comment" class="chat-box timeline">
        
      </ul>
       <ul id="show_draft_comment_detail_draft" style="display:none" class="chat-box timeline">
        
      </ul>
    </div>
    <div id="comment_detail_draft" style="display:none">
    ...
    <div class="span4">
      ...
      <div class="box profiles" >
        ...
        <div class="box-content scrollable" > 
         <ul class="box-list check" id="draft_profile_comment">
