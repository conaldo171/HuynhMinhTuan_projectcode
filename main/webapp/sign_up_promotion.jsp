...
if(request.getParameter("program")!=null){
	promotion = request.getParameter("program");
}
%>
...
<div class="span6 offset3">
	<img alt="" src="common/images/banner_promotion.png" />
</div>  
<div class="span6 offset3">
    ...
    <div class="login box">
      ...
      <div class="box-content padded">
		...
		<div class="mBT10 block-terms">
          ...
          <div>
            <a class="btn btn-blue btn-block" href="javascript:void(0);" onclick="signup('<%=promotion%>');">
