...
{ 	 
        ...
        for (i = 0; i < data.length; i++) {
            ...
            if (isNull(node)) {
                ...
                if (view) {
                    ...
                    var _item = $("#navLeft #tree-menu #" + id);
                    $(_item).parent(_item).attr("title",description);
                    
                    //$("#navLeft #tree-menu #" + id).parent("#navLeft #tree-menu #" + id).attr("title",description);
                }
				...
				if(!isNull(_groupId))
				{
					if(_groupId==group)
					{
						global_groupId=group;
						//alert(group)
						var div_id=id.replace("-","_");
						...
						$("#breadcrumbs #lev1 i").attr("class",programIcon);
						$("#icon_infor").remove();
						var div_lev3='<div id="icon_infor" style="cursor:pointer;float:right;margin-right:0px;margin-top:1px" class=""><div id="lev3_'+div_id+'" title="tooltip_'+div_id+'" tooltip="tooltip_'+div_id+'" class="breadcrumb-button" style="float:right;margin-top:10px;margin-right:-10px"><i  class="icon-info-sign"></i></div></div>'
						$("#breadcrumbs").append(div_lev3);
                ...
                for (j = 0; j < child.length; j++) {
                    ...
                    if (isNull(node1)) {
                        ...
                        if (view) {
                            ...
                            var _item = $("#navLeft #tree-menu #" + id1);
                            $(_item).parent(_item).attr("title",description1);
                        }
                    } else {
        ...
        if ($("#navLeft #tree-menu").html() != "") { 		
			...
			{		            	
				...
				}else
				{
				    ...
				    var div_lev3='<div id="icon_infor" style="cursor:pointer;float:right;margin-right:0px;margin-top:1px" class=""><div id="lev3_'+div_id+'" tooltip="tooltip_'+div_id+'" title="tooltip_'+div_id+'" class="breadcrumb-button" style="float:right;margin-top:10px;margin-right:-10px"><i   class="icon-info-sign"></i></div></div>'
					//alert(text)
					$("#breadcrumbs #lev1").show();
    ...
    {    
    	...
    	setTimeout(function(){
			...
			$("#breadcrumbs #lev1 .name").html(text);			
			$("#breadcrumbs #lev1 i").attr("class",programIcon);
			var div_lev3='<div id="icon_infor" style="cursor:pointer;float:right;margin-right:0px;margin-top:1px" class=""><div id="lev3_'+_pageId+'" tooltip="tooltip_'+_pageId+'" title="tooltip_'+_pageId+'" class="breadcrumb-button" style="float:right;margin-top:10px;margin-right:-10px"><i   class="icon-info-sign"></i></div></div>'
			$("title").html("Enpick | " + text );	
			$("#breadcrumbs").append(div_lev3);
		},100);
    }
    ...
    var language_get = function (parent, file) {
    	$("html").addClass(config.main_lang);
    	//alert(file+"__"+parent)
                    ...
                    if (_.isArray(item_val[i])) {
                        ...
                        if (!isNull(item_key)) {
                            ...
                            //if ($("html").hasClass("ie8")) {
                                ...
                                $(parent + " a[text=" + txt + "]").html(item_val[i]);
                                $(parent + " u[text=" + txt + "]").html(item_val[i]);
                                $(parent + " dd[text=" + txt + "]").html(item_val[i]);
                                $(parent + " dt[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h1[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h2[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h3[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h4[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h5[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h6[text=" + txt + "]").html(item_val[i]);
                                $(parent + " h7[text=" + txt + "]").html(item_val[i]);
                                $(parent + " strong[text=" + txt + "]").html(item_val[i]);
                                $(parent + " option[text=" + txt + "]").html(item_val[i]);
                                $(parent + " button[text=" + txt + "]").html(item_val[i]);
                                ...
                                $(parent + " optgroup[text=" + txt + "]").attr("label", item_val[i]);
                                $(parent + " a[tooltip=" + txt + "]").attr("title",item_val[i]);
                                //$(parent + " div[tooltip=" + txt + "]").attr("title",item_val[i]);
                                $("#aoFrm-Main div[tooltip=" + txt + "]").attr("title",item_val[i]);
                                if(parent=="#aoFrm-content"){
                                	
                                	$(parent + " div[tooltip=" + txt + "]").attr("title",item_val[i]);
                                	 //$(parent + " span[tooltip=" + txt + "]").attr("title",item_val[i]);
                                }
                                $(parent + " span[tooltip=" + txt + "]").attr("title",item_val[i]);
                                //return;
                            //}
                            ...
                            //$(parent + " input[text=" + txt + "]").html("");
                            //$(parent + " optgroup[text=" + txt + "]").attr("label", item_val[i]);
                                var div_tooltip=txt.replace("tooltip_","");
                                if(!isNull(div_tooltip)){
                                	 $("#lev3_"+div_tooltip).tooltip({
                                  		 html:true,
                                  		 placement:"left"
                             		 
                                  		 });
                                  		
                                	 //$("#lev3_"+div_tooltip).tooltip("open");
                                }
                                $("#aoFrm-Main div[tooltip=" + txt + "]").attr("title","");
                                $("#aoFrm-Main a[tooltip=" + txt + "]").attr("title","");
                                $("#aoFrm-Main span[tooltip=" + txt + "]").attr("title","");
                                $(parent + " span[tooltip=" + txt + "]").attr("title","");
                        }
                    }
                }
            }); 
...
$(document).ready(function(e) {
	...
	$("#help_support").click(function(){
		$("#zenbox_tab").click();
	});
	$("#link_renewal").click(function(){
		$("#zenbox_tab").click();
	});
	...
	$.ajax({
		  ...
		  success : function(source) {
			  ...
			  for(var i=0; i<source.length;i++){
				  var owner =source[i].team_role;
				  var day = Math.round((source[i].number_day)/60/60/24);
				  if(owner==1){
					  $("#day_free").html(day +" days left for free");
					  check_exprired=source[i].exprire;
					  $("#user_name_select").attr("title",source[i].first_name +" "+source[i].last_name);
					  $("#user_name_select").text(limitString(source[i].first_name +" "+source[i].last_name));
				  }
				  
					  var user_id= source[i].user_id;
					  var html='<li class="profile" id="'+user_id+'"><a title="'+source[i].first_name +" "+source[i].last_name+'" href="#"><i class="icon-user"></i><span text="profile">'+limitString(source[i].first_name +" "+source[i].last_name)+'</span></a></li> <li class="divider" style="margin:1px 1px"></li>';
						$("#dropdown_menu").prepend(html);
							...
							$.ajax({
								  ...
								  success : function(source) { 
									  for(var j=0; j<source.length;j++){
										  check_exprired=source[j].exprire;
										  if(source[j].team_role!=1){
											  $(".connect_a_channel").hide();
											  $(".group_member").hide();
										  }
										  else
											  {
											  $(".connect_a_channel").show();
											  $(".group_member").show();
											  }
										  $("#permit").val(source[j].team_role);
										  $("#user_name_select").attr("title",source[j].first_name +" "+source[j].last_name);
										  $("#user_name_select").text(limitString(source[j].first_name +" "+source[j].last_name)); 
								  }
...
dataString.push({
	...
	$.ajax({
		  ...
		  success : function(source) {
			  ...
			  for(var i=0; i<source.length;i++){
				  count_all =count_all+source[i].count_number;
			  }
			  $(".nav_contents-all .amount").html(count_all);
			  $(".nav_contents-create .amount").html("");
			  $(".nav_contents-create a span").removeClass("amount");
			 
			  if(!isNull(source[0].count_number))
			  count_draft=source[0].count_number;
			  $(".nav_contents-draft .amount").html(count_draft);	
			  if(!isNull(source[1].count_number))
			  count_schedule=source[1].count_number;
			  if(!isNull(source[2].count_number))
			  count_send=source[2].count_number;
					$(".nav_contents-scheduled .amount").html(count_schedule);	
					//$(".nav_contents-draft .amount").html(count_draft);	
					$(".nav_contents-sent .amount").html(count_send);	
