...
<title>Enpick | Reset Password</title>
			...
			<div class="padded">
				...
				<div id="activeAlready" class="login box"
					...
					<div class="box-header">
						<span class="title" style="font-size: 20px;" text="password_already">Password
					...
					<div class="box-content padded">
						<p style="color: red">
							<span text="accountexist">This account has already been created, click </span><a
								style="color: blue" href="/enpick/login.jsp">log in</a> <span text="begin">to begin
							using it.</span>
						</p>
					</div>
				</div>
				<div id="activeInvite" class="login box"
					...
					<div class="box-header">
						<span class="title" style="font-size: 20px;" text="set_your_password">Set a your
							Enpick social password</span>
					</div>

					<div class="box-content padded">
						
						<p style="" text="username_login">Your user name for login is:</p>
						<p style="color: blue; margin-bottom: 20px;" id="email"><%=email%>
						</p>
						<p style="" text="set_new_password">Set a new password:</p>
						<form class="separate-sections signupform" data-validate="parsley">
							...
							<div>
								<a class="btn btn-blue btn-block" style="width: 70%;"
									href="javascript:void(0);" onclick="updatePassword();" text="reset_you_password">
