...
<%
	...
	session.setAttribute("domain","enpick.com");
%>
  ...
  <div class="padded">
    <div class="login box" style="margin-top: 80px;">
      ...
      <div class="box-content padded">
        ...
        <div>
          <a href="sign_up.jsp">
              <span text="dontaccount">Don't have an account?</span> <strong text="signup">Sign Up</strong>
          </a>
        </div>
      </div>
    ...
    <div class="row-fluid">
      ...
      <div class="span6">
        <a href="http://twitter.com/enpick2013" target="_blank" class="btn btn-twitter btn-block"><i class="icon-twitter"></i> <span text="follow">Follow</span></a>
      </div>
    </div>
  </div>
</div>
